...
-----------------------------------------------------------------------------
<footer>
  <p>© 2024 Web研究会. All rights reserved.</p>
</footer>
-----------------------------------------------------------------------------
<pre>
  ここにコードや詩などの整形されたテキストを記述します。
</pre><!--改行はそのまま改行されて表示される-->
-----------------------------------------------------------------------------
<strong>強調したいテキスト</strong>//太字にする
<em>強調したいテキスト</em>//斜体にする
<em bedef="強調したいテキスト">強調したいテキスト</em>//強調の度合いを指定できる
-----------------------------------------------------------------------------
<q cite="https://maximum.vc/">Maximum公式サイト</q>//引用符付きで引用
-----------------------------------------------------------------------------
